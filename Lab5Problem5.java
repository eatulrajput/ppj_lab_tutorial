// Using a hierarchical inheritance, write a Java program to implement the relationship shown in
// Figure 5.2. Also, include constructors in every class to initialise the member variables.
class UniversityMember {
    ...
    Year(String name, String gender, String course, String branch, int yearID, int semID, int
    rollNumber, double SGPA) {
    ...
    Nonteaching nonteachingInfo = new Nonteaching("Prakash sharma", "Male", "NT2021",
    "Lab Assistant");
