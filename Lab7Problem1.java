// Create a class TimeFormat that contains three member variables, hour, minutes, seconds of type
// int. Define four constructors with no argument, one argument, two arguments, and three
// arguments. Also, define a method inside the class TimeFormat to display the time in the format
