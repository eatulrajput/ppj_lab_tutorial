// Modify the Java program BoxDemo.java to do the following: 1. create two objects of class Box 
...
Box box1 = new Box(); 
Box box2 = new Box(); 
// 2. Assign values to two objects using objects’ instance-variables box1.length = 5.0; // in meters 
...
// Get the volumes of two boxes using instance-variables double volume1 = box1.getVolume(); 
double volume2 = box2.getVolume(); 
System.out.println("Volume of Box 1: " + volume1 + " cubic meters"); System.out.println("Volume of Box 2: " + volume2 + " cubic meters"); // 3. Set values to two objects using parameterized methods setBoxValues(box1, 10.0, 6.0, 4.0);
...
System.out.println("New Volume of Box 1: " + newVolume1 + " cubic meters"); System.out.println("New Volume of Box 2: " + newVolume2 + " cubic meters"); } 
