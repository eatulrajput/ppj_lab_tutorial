// Write a Java program to accept the number of seconds and display its equivalent number of hours, number of minutes and number of seconds (Hint: Use / and % operators). 
