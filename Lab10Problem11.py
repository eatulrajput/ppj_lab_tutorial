# Create a class for a Product with attributes name, price, and quantity.
...
print(f"Quantity for product '{self.name}' updated to
...
total_cost = product1.calculate_total_cost()
print(f"Total cost for {product1.name} after updating quantity: ₹
{total_cost}")