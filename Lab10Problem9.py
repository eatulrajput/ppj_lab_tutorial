# Define a class for a TodoList with methods to add, remove, and display tasks. Ensure tasks are
# stored as objects of another class.
...
return f"Task: {self.description} (Priority:
