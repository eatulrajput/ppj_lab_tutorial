...
class Lab3Program3 {
    public static void main(String[] args) {
        ...
        UniMember student = new UniMember(studentName, studentGender);
        StudentDetails studentDetails = new StudentDetails(student, rollNumber);
        ...
        UniMember faculty = new UniMember(facultyName, facultyGender);
        FacultyDetails facultyDetails = new FacultyDetails(faculty, employeeId);
...
class StudentDetails {
    ...
    StudentDetails(UniMember uniMember, int rollNumber) {
...
class FacultyDetails {
    ...
    FacultyDetails(UniMember uniMember, int employeeId) {
        this.uniMember = uniMember;
