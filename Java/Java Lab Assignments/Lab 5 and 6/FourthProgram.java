...
class Year extends Student {
    ...
    Year(String name, String gender, String course, String branch, int yearID, int semID, double SGPA) {
 ...
 class FourthProgram {
	...
	System.out.println("Name: Atul Rajput");
        ...
        System.out.println();
        Year studentInfo = new Year("Atulya Singh", "Male", "BTech", "Computer Science", 2, 1, 8.5);
