// Modify the program written for Problem 2 to do the following:
// 1. Add variables to each of the classes. Add a no-argument constructor in each of the classes to
// initialise the variables to default values (0 for integers and NULL/EMPTY for strings).
